...
if __name__ == '__main__':
    ...
    try:
        ...
        #   print json.dumps(mydata, indent=4)
            ...
            x = PrettyTable()
            x.field_names = ['deviceModel', 'uuid', 'operation',
                             'hostname', 'deviceIP', 'site', 'version']
            for item in mydict["data"]:
                ...
                x.add_row([deviceModel, uuid, opmode,
                           hostname, deviceIP, siteID, version])
        ...
        #   print json.dumps(mydata, indent=4)
            ...
            x.field_names = ['deviceModel', 'uuid', 'operation', 'hostname',
                             'deviceIP', 'site', 'version', 'Certificate expire']
            try:
                for item in mydict["data"]:
                    ...
                    x.add_row([deviceModel, uuid, opmode, hostname,
                               deviceIP, siteID, version, certexpire])
            except:
                print
            print x
