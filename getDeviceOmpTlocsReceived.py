...
if __name__ == '__main__':
    ...
    try:
        ...
        api_url = "/device/omp/tlocs/received?deviceId=" + DEVICE_ID
        ...
        if response.status_code == 200:
            ...
            table = list()
            pheaderrow = ['bfd\nstatus', 'color', 'vdevice\nname', 'ip', 'pref', 'from-peer', 'weight', 'site\nid', 'originator', 'tloc\npublic-ip',
                        'tloc\npublic\nport', 'tloc\nprivate-ip', 'tloc\nprivate\nport', 'tloc\nspi', 'lastupdated', 'tloc\nencrypt\ntype']
            headerrow = ['bfd-status', 'color', 'vdevice-name', 'ip', 'preference', 'from-peer', 'weight', 'site-id', 'originator', 'tloc-public-ip',
			'tloc-public-port', 'tloc-private-ip', 'tloc-private-port', 'tloc-spi', 'lastupdated', 'tloc-encrypt-type']
