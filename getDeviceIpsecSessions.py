...
if __name__ == '__main__':
    ...
    try:
        ...
        api_url = "/device/ipsec/ike/sessions?deviceId=" + DEVICE_ID + "&&"
        ...
        if response.status_code == 200:
            ...
            table = list()
            headerrow = ['source-ip', 'source-port', 'dest-ip', 'dest-port', 'vdevice-host-name',
                         'if-name', 'vpn-id', 'version', 'state', 'uptime']
