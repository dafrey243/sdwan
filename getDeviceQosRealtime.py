    ...
    try:
        ...
        if len(sys.argv) == 3:
           ...
           interface = sys.argv[2]
            ...
            print("Two arguments required. 1)system-ip of the device to gather data, 2nd local interface\n")
            exit()

        # GET
	# "/device/ip/nat/filter?deviceId=" + DEVICE_ID + '&nat-vpn-id=0&&&'
        apilist = ["/device/interface/queue_stats?ifname=" + interface + "&af-type=ipv4&deviceId=" + DEVICE_ID]
