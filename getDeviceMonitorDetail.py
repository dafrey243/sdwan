...
if __name__ == '__main__':
    ...
    try:
        ...
        api_url = "/device/hardwarehealth/detail"
        ...
        if response.status_code == 200:
            ...
            table = list()
            pheaderrow = ['device-model', 'omp\nPeers', 'vsmart\npeers', 'system-ip', 'host-name', 'site\nid', 'version', 
                         'hardware\nState', 'uuid', 'memUsage%', 'cpuLoad%', 'lastupdated']    
            headerrow = ['device-model', 'ompPeers', 'number-vsmart-peers', 'system-ip', 'host-name', 'site-id', 'version', 
                        'hardwareState', 'uuid', 'memUsageDisplay', 'cpuLoadDisplay', 'lastupdated']
