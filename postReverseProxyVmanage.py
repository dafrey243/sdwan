    ...
    try:
        ...
        if len(sys.argv) == 4:
           ...
           port = sys.argv[4]
            ...
            print("Four arguments required. 1) UUID of vManage or vSmart 2) VPN0 IP of Device 3) IP of proxy
4) Last digit of port number(7, 8, 9).  Use unique port number for each UUID.\n")
            exit()
