...
if __name__ == '__main__':
    ...
    try:
        ...
        # GET
        apilist = ["/networkdesign/profile/feature", "/networkdesign/profile/template"]
            ...
            if response.status_code == 200:
                ...
                for item in mydict["data"][0:1]:
                    for k, v in item.items():
                        ...
                        if re.search("^(?!vdevice-dataKey|createdOn|resourceGroup|createdBy|configType|lastUpdatedOn|templateDefinition|deviceType|templateDescription|templateMinVersion)", k):
                            headerrow.append(k)
