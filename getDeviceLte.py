...
if __name__ == '__main__':
    ...
    try:
        ...
        # GET
        #"/device/cellular/modem=" + DEVICE_ID + '&&',
        apilist = ["/device/cellular/connection=" + DEVICE_ID + '&&',
                   "/device/cellular/hardware=" + DEVICE_ID + '&&',
                   "/device/cellular/network=" + DEVICE_ID + '&&',
                   "/device/cellular/profiles=" + DEVICE_ID + '&&',
                   "/device/cellular/radio=" + DEVICE_ID + '&&',
                   "/device/cellular/sessions=" + DEVICE_ID + '&&',
                   "/device/cellular/status=" + DEVICE_ID + '&&',
                   "/device/cellularEiolte/connections=" + DEVICE_ID + '&&',
                   "/device/cellularEiolte/radio=" + DEVICE_ID + '&&',
                   "/device/cellularEiolte/hardware" + DEVICE_ID + '&&',
                   "/device/cellularEiolte/network" + DEVICE_ID + '&&',
                   "/device/cellularEiolte/sim=" + DEVICE_ID + '&&']
            ...
            if response.status_code == 200:
                ...
                for item in mydict["data"][0:1]:
                    for k, v in item.items():
                        ...
                        if re.search("^(?!vdevice-dataKey)", k):
                            headerrow.append(k)
