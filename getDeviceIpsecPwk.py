...
if __name__ == '__main__':
    ...
    try:
        ...
        # GET
        apilist = ["/device/ipsec/pwk/inbound?deviceId=" + DEVICE_ID + '&&',
                   "/device/ipsec/pwk/outbound?deviceId=" + DEVICE_ID + '&&']
		...
		# Creates the header row.  camelHump and/or dash will be multiline cell
			...
			if re.search("^(?!nonce-hash|pkey-hash|d-key-hash|lastupdated|vdevice-dataKey|vdevice-name|is-ah-auth)", k):
		            headerrow.append(k)
